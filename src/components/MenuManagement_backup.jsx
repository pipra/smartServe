      ...
      {isAddModalOpen && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:p-0">
            ...
            {/* Modal Content */}
            <div className="inline-block align-bottom bg-white rounded-3xl px-8 pt-8 pb-6 text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-5xl sm:w-full max-h-[90vh] overflow-y-auto">
              {/* Enhanced Modal Header */}
              <div className="bg-gradient-to-r from-orange-50 via-red-50 to-pink-50 rounded-2xl p-6 mb-8 border border-orange-100">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    <div className="w-16 h-16 bg-gradient-to-r from-orange-500 via-red-500 to-pink-500 rounded-2xl flex items-center justify-center shadow-lg">
                    ...
                    <div>
                      ...
                      <p className="text-orange-600 font-medium text-lg">
                        Create a delicious new dish for your restaurant
                      </p>
                    </div>
                  </div>
                  <button
                    ...
                    className="bg-white hover:bg-gray-50 text-gray-400 hover:text-gray-600 rounded-full p-3 shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105"
                  >
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 rounded-2xl p-8 border border-blue-100 shadow-lg">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-blue-600 font-medium">Essential details about your menu item</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="space-y-3">
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 text-gray-900 placeholder-gray-500 bg-white shadow-sm"
                      value={formData.name}
      ...
      {isCategoryModalOpen && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:p-0">
            ...
            {/* Modal Content */}
            <div className="inline-block align-bottom bg-white rounded-3xl px-8 pt-8 pb-6 text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-3xl sm:w-full">
              {/* Enhanced Modal Header */}
              ...
              <form onSubmit={handleCategorySubmit} className="space-y-8">
                <div className="grid grid-cols-1 gap-8">
                  <div className="space-y-2">
                    ...
                    <input
                      type="text"
                      className="w-full px-4 py-4 text-lg border border-gray-200 rounded-xl focus:ring-4 focus:ring-indigo-100 focus:border-indigo-400 transition-all duration-200"
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      className="w-full px-4 py-4 text-lg border border-gray-200 rounded-xl focus:ring-4 focus:ring-indigo-100 focus:border-indigo-400 transition-all duration-200 resize-none"
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      className="w-full px-4 py-4 text-lg border border-gray-200 rounded-xl focus:ring-4 focus:ring-indigo-100 focus:border-indigo-400 transition-all duration-200 bg-white"
                ...
                {/* Enhanced Action Buttons */}
                <div className="flex justify-end space-x-6 pt-8 border-t-2 border-gray-100">
                  <button
                    type="button"
                    className="px-8 py-4 text-lg font-semibold text-gray-600 bg-gray-100 hover:bg-gray-200 rounded-xl transition-all duration-200 transform hover:scale-105 hover:shadow-lg"
                    onClick={() => {
                      setIsCategoryModalOpen(false)
                      resetCategoryForm()
                    }}
                  ...
                  <button
                    type="submit"
                    className="px-10 py-4 text-lg font-bold text-white bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 hover:from-indigo-600 hover:via-purple-600 hover:to-pink-600 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-200 transform hover:scale-105"
                    disabled={loading}
                  >
                    {loading ? (
                      <>
